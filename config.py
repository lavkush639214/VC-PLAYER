...
OWNER_ID = list(map(int, getenv("OWNER_ID", "6540206322").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/GilletringPrincessXd")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/princess_world0101")
